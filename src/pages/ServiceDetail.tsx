...
const serviceData: Record<string, ServiceData> = {
  ...
  "cabinet-refinishing": {
    ...
    blueprintSteps: [
      ...
      { title: "Surface Preparation & Protection", branded: false, description: "We encapsulate the work area to protect countertops, appliances, backsplashes, and floors. Every cabinet surface is degreased, scuff-sanded, and primed to ensure the new finish bonds properly. All hardware is removed and labeled for precise reinstallation." },
  ...
  "drywall-repairs": {
    ...
    blueprintSteps: [
      ...
      { title: "Surface Preparation & Protection", branded: false, description: "We protect floors, furniture, and adjacent surfaces before any work begins. Damaged drywall is cut out, new backing or patches installed, joints taped, multiple coats of joint compound applied, sanded smooth, and existing wall texture matched before priming." },
  ...
  "pressure-washing": {
    ...
    blueprintSteps: [
      ...
      { title: "Surface Preparation & Protection", branded: false, description: "We protect landscaping, windows, light fixtures, and any vulnerable areas before cleaning begins. Each surface is evaluated for material type, condition, and buildup — determining the right PSI, nozzle, and cleaning solution. Pre-treatment with cleaners and brighteners is applied where needed to break down mold, mildew, and staining." },
  ...
  "painter-for-a-day": {
    ...
    blueprintSteps: [
      ...
      { title: "Surface Preparation & Protection", branded: false, description: "Each task on your list gets the right prep — filling holes, sanding, masking, and protecting surrounding surfaces — so every item is done correctly, not just quickly." },
  ...
  "popcorn-ceiling-removal": {
    ...
    blueprintSteps: [
      ...
      { title: "Surface Preparation & Protection", branded: false, description: "Full containment with plastic sheeting protects floors, walls, and furniture. Texture is carefully removed, surfaces skim-coated to fill imperfections, and thoroughly sanded for a perfectly smooth result." },
