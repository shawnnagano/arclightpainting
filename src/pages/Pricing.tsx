  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="relative bg-primary text-primary-foreground py-20 md:py-28 overflow-hidden">
        <div className="absolute inset-0 bg-[url('https://arclightpainting.com/wp-content/uploads/2025/09/image-8-1.webp')] bg-cover bg-center opacity-20" />
      ...
      <section className="py-16 bg-muted/30">
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          <p className="text-muted-foreground mb-6">
            It's good to have choices. But before simply choosing the lower bid, ask yourself: <strong>Why is it cheaper?</strong>
          </p>
        ...
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-10">
            {[
              ...
              <div key={item.title} className="bg-muted/30 p-6 rounded-xl text-center">
      ...
      <section className="py-16 bg-primary text-primary-foreground">
        <div className="container mx-auto px-4 max-w-4xl text-center">
          ...
          <p className="opacity-80 mb-10">Painting Made Simple and Stress-Free</p>
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
            {blueprintSteps.map((step, i) => (
              <div key={step} className="bg-primary-foreground/10 border border-primary-foreground/20 rounded-lg p-4">
