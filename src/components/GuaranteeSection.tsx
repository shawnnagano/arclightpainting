...
const guarantees = [
  ...
  {
    title: "Backed by our Fresh Start Program",
    description:
      "Your 100% Satisfaction Guarantee doesn't expire when the project ends. With our Fresh Start Program, you're also covered by our five-year workmanship commitment—including touch-ups and repairs for peeling, blistering, or chipping paint.",
  },
];
