...
const serviceTestimonials: Record<string, Testimonial[]> = {
  ...
  "Drywall Repair": [
    { name: "James O", location: "Bothell, WA", category: "Drywall Repair", text: "We had water damage from a leak that left ugly stains and bubbling drywall. Arclight repaired everything seamlessly — you can't tell where the damage was. They matched the existing texture perfectly and painted it to blend in. Excellent work!" },
  ...
  "Color Consultation": [
    { name: "Megan R", location: "Bothell, WA", category: "Color Consultation", text: "I was paralyzed trying to pick colors for our whole main floor. The ColorConfidence Consultation changed everything — our colorist walked us through options on a video call, then sent mockups of our actual home. Seeing the colors on our house before committing made all the difference. We love every single color we chose!" },
    { name: "Hannah T", location: "Kirkland, WA", category: "Color Consultation", text: "We almost went with a color we found online, but the consultation showed us how different it would look on our specific siding. The visual mockups were eye-opening. Our colorist suggested a palette we never would have considered, and it's absolutely perfect. Worth every penny to avoid color regret!" },
    { name: "Jason W", location: "Woodinville, WA", category: "Color Consultation", text: "My wife and I disagreed on exterior colors for months. The ColorConfidence process gave us a neutral expert to guide the conversation. The on-site test patches sealed the deal — we could see exactly how each color looked in our lighting. We both love the final result and the process brought us together on it." },
    { name: "Christine B", location: "Redmond, WA", category: "Color Consultation", text: "I repainted a room myself last year and hated the color within a week. This time I used Arclight's color consultation and the difference is night and day. The Blueprint they provided had every color spec and placement mapped out. No guessing, no regret — just confidence from start to finish." },
    { name: "Marcus D", location: "Kenmore, WA", category: "Color Consultation", text: "The custom color matching alone was incredible. We wanted to match a shade from a fabric swatch and their colorist nailed it perfectly. The full ColorConfidence Blueprint made the painting process seamless — the crew knew exactly what went where. Such a smart service to offer!" },
    { name: "Allison K", location: "Mill Creek, WA", category: "Color Consultation", text: "I've always struggled with picking paint colors and usually end up with something safe and boring. The consultation pushed me out of my comfort zone in the best way. The mockups showed me how bold colors would actually look on my home, and the test patches confirmed it. Our house has never looked better!" },
  ],
};
