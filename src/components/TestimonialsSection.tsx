...
const locationTestimonials: Record<string, Testimonial[]> = {
  ...
  "Union Hill-Novelty Hill": [
    ...
    { name: "Connie P", location: "Novelty Hill, WA", category: "House Painting", text: "Arclight repainted our Novelty Hill home exterior. They carefully prepped all the siding and the finish is gorgeous. Our home looks refreshed and modern. Wonderful painters!" },
    ...
    { name: "Joanne T", location: "Novelty Hill, WA", category: "House Painting", text: "Our Novelty Hill home needed a complete exterior refresh. Arclight delivered beautifully — from power washing to the final coat. The crew was friendly, hardworking, and meticulous. Our home looks amazing!" },
  ...
  "Bellevue": [
    ...
    { name: "David L", location: "Bellevue, WA", category: "House Painting", text: "We had Arclight repaint the interior of our Bellevue home — every room, trim, and ceiling. The color consultation was incredibly helpful and the execution was perfect. Our home feels brand new. Highly recommend!" },
    { name: "Stephanie M", location: "Bellevue, WA", category: "House Painting", text: "Arclight refinished our kitchen cabinets at our Bellevue home and the transformation is unbelievable. From dated cherry to a crisp modern white — the factory-smooth finish is gorgeous. Worth every penny." },
    { name: "Robert K", location: "Bellevue, WA", category: "House Painting", text: "Had Arclight paint our Bellevue condo's interior before moving in. They were fast, tidy, and the quality is outstanding. Clean lines, smooth walls, and they left the place spotless. Great experience!" },
    ...
    { name: "Andrew P", location: "Bellevue, WA", category: "House Painting", text: "Arclight painted our Bellevue office space over a weekend. Zero disruption to our business, premium finish, and the colors match our brand perfectly. Professional from the first call to the final walkthrough." },
  ],
  "Everett": [
    ...
    { name: "Jeff H", location: "Everett, WA", category: "House Painting", text: "We had Arclight repaint the interior of our Everett home — living room, bedrooms, and all the hallways. The quality is outstanding. Smooth walls, perfect trim, and they finished right on schedule. Highly recommend!" },
    { name: "Renee B", location: "Everett, WA", category: "House Painting", text: "Arclight refinished our kitchen cabinets at our Everett home and they look like custom cabinetry now. The spray finish is incredibly smooth. They were respectful of our space and the transformation is stunning." },
    { name: "Mike W", location: "Everett, WA", category: "House Painting", text: "Had Arclight do drywall repair and painting in our Everett townhouse after a remodel. Every patch is invisible and the paint is perfectly even. Fast, professional, and great attention to detail. Very impressed!" },
    { name: "Sharon P", location: "Everett, WA", category: "House Painting", text: "Our waterfront Everett condo needed a full interior refresh. Arclight delivered beautifully — neutral tones that complement the views perfectly. They were in and out in two days. Excellent service!" },
    { name: "Greg T", location: "Everett, WA", category: "House Painting", text: "Arclight pressure washed and painted our Everett home's deck and fence. Everything looks brand new. The crew was thorough and professional. Our outdoor spaces are completely transformed. Great local painters!" },
  ],
  "Lake Forest Park": [
    { name: "Janet R", location: "Lake Forest Park, WA", category: "House Painting", text: "Arclight painted our Lake Forest Park home and took incredible care around our mature landscaping. The exterior looks beautiful and they used mildew-resistant paint perfect for our shaded lot. Professional and thoughtful crew!" },
    { name: "Dave M", location: "Lake Forest Park, WA", category: "House Painting", text: "We hired Arclight for a full interior repaint of our mid-century Lake Forest Park home. They respected the home's character while giving it a fresh, modern feel. Clean lines, perfect prep, and gorgeous results." },
    { name: "Susan C", location: "Lake Forest Park, WA", category: "House Painting", text: "Arclight refinished our kitchen cabinets and they look factory-new. The crew was meticulous and professional. Our Lake Forest Park kitchen feels completely transformed. Couldn't be happier with the quality!" },
    { name: "Tom B", location: "Lake Forest Park, WA", category: "House Painting", text: "Had Arclight paint our Lake Forest Park home's exterior — siding, trim, and deck. They prepped everything thoroughly and the finish has held up beautifully through the rain. Excellent workmanship!" },
    { name: "Karen E", location: "Lake Forest Park, WA", category: "House Painting", text: "Our wooded Lake Forest Park lot means constant moisture and mildew on the exterior. Arclight cleaned, prepped, and repainted with the right products for our environment. The house looks amazing and the paint is lasting. Great team!" },
    { name: "Phil N", location: "Lake Forest Park, WA", category: "House Painting", text: "Arclight painted three bedrooms and our living room at our Lake Forest Park home. Beautiful work — smooth walls, clean edges, and they moved furniture carefully. Would absolutely hire them again!" },
  ],
  "Clearview": [
