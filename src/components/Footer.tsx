...
import { Phone, Mail, MapPin, MessageSquareQuote, Facebook, Instagram, Linkedin } from "lucide-react";
    ...
    <footer className="bg-secondary text-foreground border-t border-border">
      ...
      <div className="container mx-auto px-4 py-12">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm opacity-70">
              <li className="flex items-center gap-2">
                ...
                <a href="tel:+14257571199" className="hover:text-accent transition-colors">(425) 757-1199</a>
              </li>
              <li className="flex items-center gap-2">
        ...
        <div className="border-t border-border mt-6 pt-6 text-center text-sm opacity-50">
          © {new Date().getFullYear()} Arclight Painting. All rights reserved. · <Link to="/privacy-policy" className="hover:underline">Privacy Policy</Link> · <Link to="/eula" className="hover:underline">EULA</Link>
        </div>
      </div>
    </footer>
  );
