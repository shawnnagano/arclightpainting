...
const steps = [
  ...
  { step: "3", title: "ColorConfidence™ Consultation", rendered: <Link to="/color-consultation" className="text-foreground hover:text-accent transition-colors duration-200">ColorConfidence™ Consultation</Link>, isLink: true },
